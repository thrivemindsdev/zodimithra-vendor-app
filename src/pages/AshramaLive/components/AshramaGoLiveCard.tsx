...
const AshramaGoLiveCard = ({
  ...
  const inputClass =
    " mt-5 h-10 w-full rounded-xl  border border-white/20  bg-white/10  px-3  text-sm  text-white  placeholder:text-white/70 outline-none focus:border-white/40";

  return (
    <div className="rounded-3xl bg-linear-to-b from-[#7d2f30] to-[#9b3832] p-6 text-white shadow-lg">
